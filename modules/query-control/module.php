<?php
namespace KoopoWidgets\Modules\QueryControl;

use Elementor\Controls_Manager;
use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use Elementor\Widget_Base;
use KoopoWidgets\Base\Module_Base;
use KoopoWidgets\Modules\QueryControl\Controls\Group_Control_Posts;
use KoopoWidgets\Modules\QueryControl\Controls\Group_Control_Query;
use KoopoWidgets\Modules\QueryControl\Controls\Group_Control_Related;
use KoopoWidgets\Modules\QueryControl\Classes\Elementor_Post_Query;
use KoopoWidgets\Modules\QueryControl\Classes\Elementor_Related_Query;
use KoopoWidgets\Modules\QueryControl\Controls\Query;
use KoopoWidgets\Plugin;
...
class Module extends Module_Base {
	...
	/**
	 * @param \KoopoWidgets\Base\Base_Widget $widget
	 * @param string $name
