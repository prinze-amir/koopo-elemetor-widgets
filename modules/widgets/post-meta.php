...
class PostMeta extends Widget_Base {
	...
	public function get_title() {
		return __( 'Post Meta', 'koopo-widgets' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Meta Data', 'koopo-widgets' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => __( 'Default', 'koopo-widgets' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => __( 'Inline', 'koopo-widgets' ),
		...
		$repeater->add_control(
			'type',
			[
				'label' => __( 'Type', 'koopo-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'date',
				'options' => [
					'author' => __( 'Author', 'koopo-widgets' ),
					'date' => __( 'Date', 'koopo-widgets' ),
					'time' => __( 'Time', 'koopo-widgets' ),
					'comments' => __( 'Comments', 'koopo-widgets' ),
					'terms' => __( 'Terms', 'koopo-widgets' ),
		...
		$repeater->add_control(
			'date_format',
			[
				'label' => __( 'Date Format', 'koopo-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
					'0' => _x( 'March 6, 2018 (F j, Y)', 'Date Format', 'koopo-widgets' ),
					'1' => '2018-03-06 (Y-m-d)',
					'2' => '03/06/2018 (m/d/Y)',
					'3' => '06/03/2018 (d/m/Y)',
					'custom' => __( 'Custom', 'koopo-widgets' ),
		...
		$repeater->add_control(
			'custom_date_format',
			[
				'label' => __( 'Custom Date Format', 'koopo-widgets' ),
				...
				'description' => sprintf(
					...
					__( 'Use the letters: %s', 'koopo-widgets' ),
		...
		$repeater->add_control(
			'time_format',
			[
				'label' => __( 'Time Format', 'koopo-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
		...
		$repeater->add_control(
			'custom_time_format',
			[
				'label' => __( 'Custom Time Format', 'koopo-widgets' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'g:i a',
				'placeholder' => 'g:i a',
				'condition' => [
		...
		$repeater->add_control(
			'taxonomy',
			[
				'label' => __( 'Taxonomy', 'koopo-widgets' ),
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Custom Format', 'koopo-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => false,
				'condition' => [
					'type' => 'comments',
		...
		$repeater->add_control(
			'string_no_comments',
			[
				'label' => __( 'No Comments', 'koopo-widgets' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'No Comments', 'koopo-widgets' ),
				'condition' => [
		...
		$repeater->add_control(
			'string_one_comment',
			[
				'label' => __( 'One Comment', 'koopo-widgets' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'One Comment', 'koopo-widgets' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'string_comments',
			[
				'label' => __( 'Comments', 'koopo-widgets' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( '%s Comments', 'koopo-widgets' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'custom_url',
			[
				'label' => __( 'Custom URL', 'koopo-widgets' ),
		...
		$repeater->add_control(
			'show_icon',
			[
				'label' => __( 'Icon', 'koopo-widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => __( 'None', 'koopo-widgets' ),
					'default' => __( 'Default', 'koopo-widgets' ),
					'custom' => __( 'Custom', 'koopo-widgets' ),
				],
				'default' => 'default',
				'condition' => [
		...
		$repeater->add_control(
			'selected_icon',
			[
				'label' => __( 'Choose Icon', 'koopo-widgets' ),
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => __( 'Space Between', 'koopo-widgets' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			'divider',
			[
				'label' => __( 'Divider', 'koopo-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Off', 'koopo-widgets' ),
				'label_on' => __( 'On', 'koopo-widgets' ),
				'selectors' => [
		...
		$this->add_control(
			'divider_style',
			[
				'label' => __( 'Style', 'koopo-widgets' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'solid' => __( 'Solid', 'koopo-widgets' ),
					'double' => __( 'Double', 'koopo-widgets' ),
					'dotted' => __( 'Dotted', 'koopo-widgets' ),
					'dashed' => __( 'Dashed', 'koopo-widgets' ),
				],
				'default' => 'solid',
				'condition' => [
					'divider' => 'yes',
	...
	protected function get_meta_data( $repeater_item ) {
		...
		switch ( $repeater_item['type'] ) {
			...
			case 'comments':
				if ( comments_open() ) {
					$default_strings = [
						'string_no_comments' => __( 'No Comments', 'koopo-widgets' ),
						'string_one_comment' => __( 'One Comment', 'koopo-widgets' ),
						'string_comments' => __( '%s Comments', 'koopo-widgets' ),
					];
					...
					if ( 0 === $num_comments ) {
						...
						$item_data['text'] = sprintf( _n( $default_strings['string_one_comment'], $default_strings['string_comments'], $num_comments, 'koopo-widgets' ), $num_comments );
					}
