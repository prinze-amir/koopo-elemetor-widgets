 ...
 * @since 1.0.0
 */
class BannerImage extends Widget_Base {
	...
	public function get_title() {
		return __( 'Banner Image', 'elementor' );
	}
	...
	public function get_keywords() {
		return [ 'image', 'photo', 'visual', 'banner image' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => __( 'Banner Image', 'elementor' ),
			]
		);
	...
	protected function render() {
        ...
        $trackimg = get_post_meta($post->ID, 'dzsap_meta_wrapper_image', true);
       ...
       /* if (empty($trackimg)){
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>	
           ...
           // echo Group_Control_Image_Size::get_attachment_image_html( $settings ); 
            echo '<img width="100%" src="'. $trackimg .'">';
            ?>
