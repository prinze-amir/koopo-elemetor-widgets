<?php
namespace KoopoWidgets\Modules\Posts\Widgets;

use Elementor\Controls_Manager;
use KoopoWidgets\Modules\QueryControl\Module as Module_Query;
use KoopoWidgets\Modules\QueryControl\Controls\Group_Control_Related;
use KoopoWidgets\Modules\Posts\Skins;
...
class Posts extends Posts_Base {
	...
	public function get_title() {
		return __( 'K-Posts', 'elementor-pro' );
	}
